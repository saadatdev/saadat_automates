...
const Eyes: React.FC<{ mouseX: number; mouseY: number; focusOnEmail: boolean }> = ({ mouseX, mouseY, focusOnEmail }) => {
  ...
  return (
    <div className="flex gap-6 justify-center items-center">
      <div className="w-20 h-20 bg-[#FFFFFF]/20 rounded-full flex items-center justify-center shadow-lg">
        <div 
          ref={leftEyeRef}
          className={`${focusOnEmail ? 'w-12 h-12' : 'w-10 h-10'} rounded-full bg-white transition-all duration-300`}
        />
      </div>
      <div className="w-20 h-20 bg-[#FFFFFF]/20 rounded-full flex items-center justify-center shadow-lg">
        <div 
...
const ContactFooter = () => {
  ...
  return (
    <motion.div
      ...
      className="w-full max-w-[1200px] mx-auto min-h-[200px] bg-gradient-to-r from-[#0A0A0A] to-[#1A1A1A] text-[#FFFFFF] py-8 px-12 rounded-3xl shadow-2xl border border-[#A855F7]/30 backdrop-blur-xl mb-16"
    >
        ...
        <div className="flex flex-col gap-8 flex-grow">
          <div className="space-y-4">
            ...
            <motion.a 
              ...
              className="text-4xl font-medium text-[#FFFFFF] hover:text-[#A855F7] transition-colors duration-300 block"
